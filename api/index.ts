...
ДОХОДЫ (income type):
- Платежи ОТ клиентов (от контрагентов к нам)
- Продажи, выручка
- Поступления, платежи за услуги
- Возвраты денег (если мы получали)
- Ключевые слова: "платеж от", "поступление от", "доход", "выручка", "продажа", "оплата за услугу"

РАСХОДЫ (expense type):
- Платежи МЫ совершаем (платежи контрагентам)
- Зарплата, ФОТ
- Софт, SaaS, подписки
- Реклама, маркетинг
- Аренда
- Налоги
- Комиссии
- Ключевые слова: "оплата", "платеж", "зарплата", "ФОТ", "софт", "реклама", "маркетинг", "аренда", "налог", "комиссия"

СПОСОБ РАЗЛИЧИТЬ:
- ДОХОД: "платеж ОТ клиента", "поступление", "оплата от"
- РАСХОД: "платеж контрагенту", "оплата", "зарплата", "комиссия"

Ответь ТОЛЬКО JSON массивом объектов, БЕЗ дополнительного текста:
[
  {
